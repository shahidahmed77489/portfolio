      ...
      <div>
        ...
        <div className="mt-6 lgl:mt-14 w-full h-fit border-l-[6px] border-l-black border-opacity-30 flex flex-col gap-10">
          <ResumeCard
            ...
            result="New Delhi"
            des=" One-year job experience demonstrates practical skills, adaptability, and professional growth, enhancing expertise and contributing value in various roles."
          />
